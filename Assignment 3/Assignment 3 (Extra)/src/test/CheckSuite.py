...
class CheckSuite(unittest.TestCase):
    ...
    def test_case_37(self):
        ...
        EndBody.
        """
        expect = str(TypeCannotBeInferred(Return(ArrayCell(CallExpr(Id('foo'),[]),[IntLiteral(2),IntLiteral(1)]))))
    ...
    def test_case_97(self):
        ...
        Function: f
        Body:
            foo(float_of_int(x))[2] = string_of_int(b[x]);
        EndBody.
        """
        expect = str(TypeMismatchInStatement(Assign(ArrayCell(CallExpr(Id('foo'),[CallExpr(Id('float_of_int'),[Id('x')])]),[IntLiteral(2)]),CallExpr(Id('string_of_int'),[ArrayCell(Id('b'),[Id('x')])]))))
    ...
    def test_case_102(self):
        ...
        EndBody.
        """
        expect = str(TypeMismatchInExpression(CallExpr(Id('foo'),[CallExpr(Id('int_of_float'),[Id('k')])])))
